<template>
   <div>
      <!-- Cart Mobile Button ***DA SISTEMAREEEEEEEEEEEEEEEE* -->
      <a
         v-if="
            getTotalQuantity &&
      ...
      <div id="restaurant-show" class="container-fluid pb-5">
         ...
         <div
            id="restaurant-info"
            v-else
            class="row bg-white pb-3 shadow-sm mb-3"
         >
            <!-- RISTORANTE -->
               ...
               <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <h6>
                           Nel carrello sono presenti prodotti di un altro
                           ristorante, sei sicuro di volerli eliminare e creare
                           un nuovo carrello?
                        </h6>
                     </div>
   ...
   watch: {
      currentRestaurant: {
         handler(newCurrentRestaurant) {
            sessionStorage.currentRestaurant =
